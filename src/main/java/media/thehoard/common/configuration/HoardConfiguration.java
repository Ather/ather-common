...
public class HoardConfiguration {
	 ...
	 * ~/.config/hoardmedia/hoardmediaserver/hoardmediaserver.json on Non-windows operating systems, and
	 * %LOCALAPPDATA%\The Hoard Media\The Hoard Media Server\hoardmediaserver.json on Windows.
	 */
