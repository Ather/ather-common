 ...
 * 
 */
package media.thehoard.common.database.tables;
...
import media.thehoard.common.providers.generic.Provider.ProviderStatus;
import media.thehoard.common.providers.generic.Provider.ProviderUsages;
...
public class Provider<CredentialClass extends ProviderCredential<?>, ConfigurationClass extends ProviderConfiguration<?>, ProviderServiceClass extends ProviderService<?, ?, ?, ?, ?, ?>> {
	...
	protected void onCreate() {
		...
		if (alias == null)
			alias = "";
		if (type == null)
			type = ProviderUsages.REPOSITORY;
		if (status == null)
