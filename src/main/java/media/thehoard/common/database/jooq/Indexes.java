...
public class Indexes {
    ...
    private static class Indexes0 extends AbstractKeys {
        ...
        public static Index DEVICES_PRIMARY = createIndex("PRIMARY", Devices.DEVICES, new OrderField[] { Devices.DEVICES.ID }, true);
        public static Index DISTRIBUTORDESTINATIONS_ID_UNIQUE = createIndex("id_UNIQUE", Distributordestinations.DISTRIBUTORDESTINATIONS, new OrderField[] { Distributordestinations.DISTRIBUTORDESTINATIONS.ID }, true);
        public static Index DISTRIBUTORDESTINATIONS_PRIMARY = createIndex("PRIMARY", Distributordestinations.DISTRIBUTORDESTINATIONS, new OrderField[] { Distributordestinations.DISTRIBUTORDESTINATIONS.ID }, true);
        public static Index DISTRIBUTORDIRECTORIES_ID_UNIQUE = createIndex("id_UNIQUE", Distributordirectories.DISTRIBUTORDIRECTORIES, new OrderField[] { Distributordirectories.DISTRIBUTORDIRECTORIES.ID }, true);
        public static Index DISTRIBUTORDIRECTORIES_PRIMARY = createIndex("PRIMARY", Distributordirectories.DISTRIBUTORDIRECTORIES, new OrderField[] { Distributordirectories.DISTRIBUTORDIRECTORIES.ID }, true);
        public static Index DISTRIBUTORQUEUE_ID_UNIQUE = createIndex("id_UNIQUE", Distributorqueue.DISTRIBUTORQUEUE, new OrderField[] { Distributorqueue.DISTRIBUTORQUEUE.ID }, true);
        public static Index DISTRIBUTORQUEUE_PRIMARY = createIndex("PRIMARY", Distributorqueue.DISTRIBUTORQUEUE, new OrderField[] { Distributorqueue.DISTRIBUTORQUEUE.ID }, true);
        public static Index HOMEACCOUNTS_ID_UNIQUE = createIndex("id_UNIQUE", Homeaccounts.HOMEACCOUNTS, new OrderField[] { Homeaccounts.HOMEACCOUNTS.ID }, true);
        public static Index HOMEACCOUNTS_PRIMARY = createIndex("PRIMARY", Homeaccounts.HOMEACCOUNTS, new OrderField[] { Homeaccounts.HOMEACCOUNTS.ID }, true);
        public static Index HOMES_ID_UNIQUE = createIndex("id_UNIQUE", Homes.HOMES, new OrderField[] { Homes.HOMES.ID }, true);
        public static Index HOMES_PRIMARY = createIndex("PRIMARY", Homes.HOMES, new OrderField[] { Homes.HOMES.ID }, true);
        public static Index MEDIACHAPTERS_ID_UNIQUE = createIndex("Id_UNIQUE", Mediachapters.MEDIACHAPTERS, new OrderField[] { Mediachapters.MEDIACHAPTERS.ID }, true);
        public static Index MEDIACHAPTERS_PRIMARY = createIndex("PRIMARY", Mediachapters.MEDIACHAPTERS, new OrderField[] { Mediachapters.MEDIACHAPTERS.ID }, true);
        public static Index MEDIACHAPTERS_UUID_UNIQUE = createIndex("Uuid_UNIQUE", Mediachapters.MEDIACHAPTERS, new OrderField[] { Mediachapters.MEDIACHAPTERS.UUID }, true);
        public static Index MEDIAFILES_ID_UNIQUE = createIndex("Id_UNIQUE", Mediafiles.MEDIAFILES, new OrderField[] { Mediafiles.MEDIAFILES.ID }, true);
        public static Index MEDIAFILES_PRIMARY = createIndex("PRIMARY", Mediafiles.MEDIAFILES, new OrderField[] { Mediafiles.MEDIAFILES.ID }, true);
        public static Index MEDIAFILES_UUID_UNIQUE = createIndex("Uuid_UNIQUE", Mediafiles.MEDIAFILES, new OrderField[] { Mediafiles.MEDIAFILES.UUID }, true);
        public static Index MEDIASTREAMS_ID_UNIQUE = createIndex("Id_UNIQUE", Mediastreams.MEDIASTREAMS, new OrderField[] { Mediastreams.MEDIASTREAMS.ID }, true);
        public static Index MEDIASTREAMS_PRIMARY = createIndex("PRIMARY", Mediastreams.MEDIASTREAMS, new OrderField[] { Mediastreams.MEDIASTREAMS.ID }, true);
        public static Index MEDIASTREAMS_UUID_UNIQUE = createIndex("Uuid_UNIQUE", Mediastreams.MEDIASTREAMS, new OrderField[] { Mediastreams.MEDIASTREAMS.UUID }, true);
        public static Index PARTIES_ID_UNIQUE = createIndex("id_UNIQUE", Parties.PARTIES, new OrderField[] { Parties.PARTIES.ID }, true);
        public static Index PARTIES_PRIMARY = createIndex("PRIMARY", Parties.PARTIES, new OrderField[] { Parties.PARTIES.ID }, true);
        public static Index PARTYACCOUNTS_ID_UNIQUE = createIndex("id_UNIQUE", Partyaccounts.PARTYACCOUNTS, new OrderField[] { Partyaccounts.PARTYACCOUNTS.ID }, true);
        public static Index PARTYACCOUNTS_PRIMARY = createIndex("PRIMARY", Partyaccounts.PARTYACCOUNTS, new OrderField[] { Partyaccounts.PARTYACCOUNTS.ID }, true);
        public static Index PROVIDERFILERELATIONSHIPS_ID_UNIQUE = createIndex("Id_UNIQUE", Providerfilerelationships.PROVIDERFILERELATIONSHIPS, new OrderField[] { Providerfilerelationships.PROVIDERFILERELATIONSHIPS.ID }, true);
        public static Index PROVIDERFILERELATIONSHIPS_PRIMARY = createIndex("PRIMARY", Providerfilerelationships.PROVIDERFILERELATIONSHIPS, new OrderField[] { Providerfilerelationships.PROVIDERFILERELATIONSHIPS.ID }, true);
        public static Index PROVIDERFILES_ID_UNIQUE = createIndex("id_UNIQUE", Providerfiles.PROVIDERFILES, new OrderField[] { Providerfiles.PROVIDERFILES.ID }, true);
        public static Index PROVIDERFILES_PRIMARY = createIndex("PRIMARY", Providerfiles.PROVIDERFILES, new OrderField[] { Providerfiles.PROVIDERFILES.ID }, true);
        public static Index PROVIDERFILES_UUID_UNIQUE = createIndex("Uuid_UNIQUE", Providerfiles.PROVIDERFILES, new OrderField[] { Providerfiles.PROVIDERFILES.UUID }, true);
        public static Index PROVIDERS_ID_UNIQUE = createIndex("Id_UNIQUE", Providers.PROVIDERS, new OrderField[] { Providers.PROVIDERS.ID }, true);
        public static Index PROVIDERS_PRIMARY = createIndex("PRIMARY", Providers.PROVIDERS, new OrderField[] { Providers.PROVIDERS.ID }, true);
        public static Index PROVIDERS_UUID_UNIQUE = createIndex("Uuid_UNIQUE", Providers.PROVIDERS, new OrderField[] { Providers.PROVIDERS.UUID }, true);
        public static Index PROVIDERSOLD_ID_UNIQUE = createIndex("id_UNIQUE", Providersold.PROVIDERSOLD, new OrderField[] { Providersold.PROVIDERSOLD.ID }, true);
        public static Index PROVIDERSOLD_PRIMARY = createIndex("PRIMARY", Providersold.PROVIDERSOLD, new OrderField[] { Providersold.PROVIDERSOLD.ID }, true);
        ...
        public static Index VIRTUALPROVIDERS_NAME_UNIQUE = createIndex("name_UNIQUE", Virtualproviders.VIRTUALPROVIDERS, new OrderField[] { Virtualproviders.VIRTUALPROVIDERS.NAME }, true);
        public static Index VIRTUALPROVIDERS_PRIMARY = createIndex("PRIMARY", Virtualproviders.VIRTUALPROVIDERS, new OrderField[] { Virtualproviders.VIRTUALPROVIDERS.ID }, true);
        public static Index VIRTUALPROVIDERS_UUID_UNIQUE = createIndex("uuid_UNIQUE", Virtualproviders.VIRTUALPROVIDERS, new OrderField[] { Virtualproviders.VIRTUALPROVIDERS.UUID }, true);
    }
}
