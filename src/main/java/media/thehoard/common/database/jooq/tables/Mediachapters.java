...
public class Mediachapters extends TableImpl<MediachaptersRecord> {
     ...
     */
    public final TableField<MediachaptersRecord, Integer> ID = createField("Id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>thehoard.MediaChapters.Uuid</code>.
     */
    public final TableField<MediachaptersRecord, String> UUID = createField("Uuid", org.jooq.impl.SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>thehoard.MediaChapters.MediaFileUuid</code>.
     */
    public final TableField<MediachaptersRecord, String> MEDIAFILEUUID = createField("MediaFileUuid", org.jooq.impl.SQLDataType.VARCHAR(36).nullable(false), this, "");
     ...
     */
    public final TableField<MediachaptersRecord, Double> START = createField("Start", org.jooq.impl.SQLDataType.DOUBLE.nullable(false), this, "");

    /**
     * The column <code>thehoard.MediaChapters.End</code>.
     */
    public final TableField<MediachaptersRecord, Double> END = createField("End", org.jooq.impl.SQLDataType.DOUBLE.nullable(false), this, "");

    /**
     * The column <code>thehoard.MediaChapters.Title</code>.
     */
    public final TableField<MediachaptersRecord, String> TITLE = createField("Title", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");
