...
public class Virtualproviders extends TableImpl<VirtualprovidersRecord> {
    ...
    private static final long serialVersionUID = 2097676085;
     ...
     */
    public final TableField<VirtualprovidersRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>thehoard.VirtualProviders.uuid</code>.
     */
    public final TableField<VirtualprovidersRecord, String> UUID = createField("uuid", org.jooq.impl.SQLDataType.VARCHAR(36).nullable(false), this, "");
     ...
     */
    public final TableField<VirtualprovidersRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "This is required to be unique, because you will have a bad time otherwise.");

    /**
     * The column <code>thehoard.VirtualProviders.dateCreated</code>.
     */
    public final TableField<VirtualprovidersRecord, Timestamp> DATECREATED = createField("dateCreated", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>thehoard.VirtualProviders.dateUpdated</code>.
     */
    public final TableField<VirtualprovidersRecord, Timestamp> DATEUPDATED = createField("dateUpdated", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>thehoard.VirtualProviders.dateDeleted</code>.
     */
    public final TableField<VirtualprovidersRecord, Timestamp> DATEDELETED = createField("dateDeleted", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
