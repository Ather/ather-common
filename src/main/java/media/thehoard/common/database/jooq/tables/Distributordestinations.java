...
public class Distributordestinations extends TableImpl<DistributordestinationsRecord> {
     ...
     */
    public final TableField<DistributordestinationsRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>thehoard.distributorDestinations.provider</code>.
     */
    public final TableField<DistributordestinationsRecord, Integer> PROVIDER = createField("provider", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>thehoard.distributorDestinations.status</code>.
     */
    public final TableField<DistributordestinationsRecord, Byte> STATUS = createField("status", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "");

    /**
     * The column <code>thehoard.distributorDestinations.rootFile</code>.
     */
    public final TableField<DistributordestinationsRecord, String> ROOTFILE = createField("rootFile", org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");
