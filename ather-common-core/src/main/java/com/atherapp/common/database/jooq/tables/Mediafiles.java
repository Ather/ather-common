...
import com.atherapp.common.database.jooq.tables.records.MediafilesRecord;
import com.atherapp.common.database.jooq.tables.records.MediafilesRecord;
import org.jooq.*;
...
public class Mediafiles extends TableImpl<MediafilesRecord> {
	 ...
	 */
	public final TableField<MediafilesRecord, Integer> ID = createField("Id", org.jooq.impl.SQLDataType.INTEGER
			.nullable(false).identity(true), this, "");
	/**
	 * The column <code>thehoard.MediaFiles.Uuid</code>.
	 */
	public final TableField<MediafilesRecord, String> UUID = createField("Uuid", org.jooq.impl.SQLDataType.VARCHAR(36)
			.nullable(false), this, "");
	/**
	 * The column <code>thehoard.MediaFiles.ProviderFileUuid</code>.
	 */
	public final TableField<MediafilesRecord, String> PROVIDERFILEUUID = createField("ProviderFileUuid", org.jooq.impl.SQLDataType
			.VARCHAR(36).nullable(false), this, "");
	/**
	 * The column <code>thehoard.MediaFiles.StreamCount</code>.
	 */
	public final TableField<MediafilesRecord, Short> STREAMCOUNT = createField("StreamCount", org.jooq.impl.SQLDataType.SMALLINT
			.nullable(false), this, "");
	/**
	 * The column <code>thehoard.MediaFiles.Format</code>.
	 */
	public final TableField<MediafilesRecord, String> FORMAT = createField("Format", org.jooq.impl.SQLDataType
			.VARCHAR(128).nullable(false), this, "");
	/**
