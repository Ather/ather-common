...
import com.atherapp.common.database.jooq.tables.records.DevicesRecord;
import com.atherapp.common.database.jooq.tables.records.DevicesRecord;
import org.jooq.*;
...
public class Devices extends TableImpl<DevicesRecord> {
	 ...
	 */
	public final TableField<DevicesRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER
			.nullable(false).identity(true), this, "");
	/**
	 * The column <code>thehoard.devices.uuid</code>.
	 */
	public final TableField<DevicesRecord, String> UUID = createField("uuid", org.jooq.impl.SQLDataType
			.VARCHAR(100), this, "");
	/**
	 * The column <code>thehoard.devices.name</code>.
	 */
	public final TableField<DevicesRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType
			.VARCHAR(255), this, "");
	/**
