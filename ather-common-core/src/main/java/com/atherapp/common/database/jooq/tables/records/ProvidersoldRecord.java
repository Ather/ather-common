...
import com.atherapp.common.database.jooq.tables.Providersold;
...
public class ProvidersoldRecord extends UpdatableRecordImpl<ProvidersoldRecord> implements
		Record13<Integer, String, Byte, String, String, String, Timestamp, Timestamp, Timestamp, Integer, Byte, byte[], Integer> {
