...
import com.atherapp.common.database.jooq.tables.records.DistributorqueueRecord;
import com.atherapp.common.database.jooq.tables.records.DistributorqueueRecord;
import org.jooq.*;
...
public class Distributorqueue extends TableImpl<DistributorqueueRecord> {
	...
	private static final long serialVersionUID = 159241196;
	/**
	 * The column <code>thehoard.distributorQueue.id</code>.
	 */
	public final TableField<DistributorqueueRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER
			.nullable(false).identity(true), this, "");
	/**
	 * The column <code>thehoard.distributorQueue.fileName</code>.
	 */
	public final TableField<DistributorqueueRecord, String> FILENAME = createField("fileName", org.jooq.impl.SQLDataType
			.VARCHAR(255).nullable(false), this, "");
	/**
	 * The column <code>thehoard.distributorQueue.pathToFile</code>.
	 */
	public final TableField<DistributorqueueRecord, String> PATHTOFILE = createField("pathToFile", org.jooq.impl.SQLDataType
			.VARCHAR(255).nullable(false), this, "");
	/**
	 * The column <code>thehoard.distributorQueue.createdAt</code>.
	 */
	public final TableField<DistributorqueueRecord, Timestamp> CREATEDAT = createField("createdAt", org.jooq.impl.SQLDataType.TIMESTAMP
	...
	public final TableField<DistributorqueueRecord, Object> PROBEINFO = createField("probeInfo", org.jooq.impl.DefaultDataType
			.getDefaultDataType("json"), this, "");
	/**
	 * The column <code>thehoard.distributorQueue.status</code>.
	 */
	public final TableField<DistributorqueueRecord, Byte> STATUS = createField("status", org.jooq.impl.SQLDataType.TINYINT
			.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "");
