...
import com.atherapp.common.database.jooq.tables.records.MediastreamsRecord;
import com.atherapp.common.database.jooq.tables.records.MediastreamsRecord;
import org.jooq.*;
...
public class Mediastreams extends TableImpl<MediastreamsRecord> {
	 ...
	 */
	public final TableField<MediastreamsRecord, Integer> ID = createField("Id", org.jooq.impl.SQLDataType.INTEGER
			.nullable(false).identity(true), this, "");
	/**
	 * The column <code>thehoard.MediaStreams.Uuid</code>.
	 */
	public final TableField<MediastreamsRecord, String> UUID = createField("Uuid", org.jooq.impl.SQLDataType.VARCHAR(36)
			.nullable(false), this, "");
	/**
	 * The column <code>thehoard.MediaStreams.MediaFileUuid</code>.
	 */
	public final TableField<MediastreamsRecord, String> MEDIAFILEUUID = createField("MediaFileUuid", org.jooq.impl.SQLDataType
			.VARCHAR(36).nullable(false), this, "");
	/**
	 * The column <code>thehoard.MediaStreams.Index</code>.
	 */
	public final TableField<MediastreamsRecord, Short> INDEX = createField("Index", org.jooq.impl.SQLDataType.SMALLINT
			.nullable(false), this, "");
	/**
	 * The column <code>thehoard.MediaStreams.CodecName</code>.
	 */
	public final TableField<MediastreamsRecord, String> CODECNAME = createField("CodecName", org.jooq.impl.SQLDataType
			.VARCHAR(20).nullable(false), this, "");
	/**
	 * The column <code>thehoard.MediaStreams.Profile</code>.
	 */
	public final TableField<MediastreamsRecord, String> PROFILE = createField("Profile", org.jooq.impl.SQLDataType
			.VARCHAR(45), this, "");
	/**
	 ...
	 */
	public final TableField<MediastreamsRecord, String> PIXELFORMAT = createField("PixelFormat", org.jooq.impl.SQLDataType
			.VARCHAR(20), this, "");
	/**
	 ...
	 */
	public final TableField<MediastreamsRecord, Boolean> ISDEFAULT = createField("IsDefault", org.jooq.impl.SQLDataType.BIT
			.nullable(false).defaultValue(org.jooq.impl.DSL.inline("b'0'", org.jooq.impl.SQLDataType.BIT)), this, "");
	/**
	 * The column <code>thehoard.MediaStreams.IsForced</code>.
	 */
	public final TableField<MediastreamsRecord, Boolean> ISFORCED = createField("IsForced", org.jooq.impl.SQLDataType.BIT
			.nullable(false).defaultValue(org.jooq.impl.DSL.inline("b'0'", org.jooq.impl.SQLDataType.BIT)), this, "");
	/**
	 * The column <code>thehoard.MediaStreams.IsExternal</code>.
	 */
	public final TableField<MediastreamsRecord, Boolean> ISEXTERNAL = createField("IsExternal", org.jooq.impl.SQLDataType.BIT
			.nullable(false).defaultValue(org.jooq.impl.DSL.inline("b'0'", org.jooq.impl.SQLDataType.BIT)), this, "");
	/**
	 * The column <code>thehoard.MediaStreams.Language</code>.
	 */
	public final TableField<MediastreamsRecord, String> LANGUAGE = createField("Language", org.jooq.impl.SQLDataType
			.VARCHAR(3), this, "");
	/**
	 * The column <code>thehoard.MediaStreams.Title</code>.
	 */
	public final TableField<MediastreamsRecord, String> TITLE = createField("Title", org.jooq.impl.SQLDataType
			.VARCHAR(255), this, "");
	/**
	 ...
	 */
	public final TableField<MediastreamsRecord, String> CHANNELLAYOUT = createField("ChannelLayout", org.jooq.impl.SQLDataType
			.VARCHAR(45), this, "");
