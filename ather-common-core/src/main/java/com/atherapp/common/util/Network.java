...
public class Network {
	...
	public static String parseCallbackAddress() {
		String test = AtherConfiguration.contents().getBindAddress();
		if (test.equals("127.0.0.1") || test.equals("localhost")) return test;
		if (test.matches("^.[0-9]{1,3}/..[0-9]{1,3}/..[0-9]{1,3}/..[0-9]{1,3}")) return "127.0.0.1";
	...
	public static String parseAddress() {
		String test = AtherConfiguration.contents().getBindAddress();
		if (test.equals("127.0.0.1") || test.equals("localhost")) return getExternalAddress();
		if (test.matches("^.[0-9]{1,3}/..[0-9]{1,3}/..[0-9]{1,3}/..[0-9]{1,3}")) return test;
